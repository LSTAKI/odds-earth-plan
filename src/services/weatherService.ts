// Weather service for fetching real NASA and weather data
...
// Fetch multi-year historical data for trends
...
export const calculateProbabilities = async (
  ...
  try {
    ...
    // Fetch 10 years of data for the same date (±3 days window)
